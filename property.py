...
def viewProperty(a):
    ...
    print("{0:<15s}{1:<30s}{2:<30s}{3:<30s}{4:>20s}".format("property id","name","address","no of rooms","owner id"))
    print("---------------------------------------------------------------------------------------------------------------------------")
    for owner in displayProperty:
        print("{0:<15s}{1:<30s}{2:<30s}{3:<30d}{4:>20s}".format(owner["id"],owner["name"],owner["address"],owner["room"],owner["ownerid"]))
    print("---------------------------------------------------------------------------------------------------------------------------")
    propertyDash(a)
